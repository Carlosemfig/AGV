...
def follow_the_path(bg,path,size_x,size_y,spacing):
    ...
    while counter<50:
      ...
      for object in tracker:
        ...
        if object.get_vector_front() is None:
          #neste caso é a primeira iteração (porque o vetor ainda não foi atualizado)
          driving.first_time(object,path)
          driving.print_dic()
          ...
          driving.other_time(object,path)
          driving.print_dic()
