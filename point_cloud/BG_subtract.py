...
final_map=m.merge_arrays(bg,cube_1,cube_2)

potint_cloud=m.array_to_pc(final_map)

result=m.subtract_array(bg,final_map)

result_pc=m.array_to_pc(result)

m.visualize(potint_cloud)
m.visualize(result_pc)
