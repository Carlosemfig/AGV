...
def follow_the_path(background,path,size_x,size_y,spacing):
    ...
    for x, y, z in path:
        ...
        if random_number>=0.7:
            cube_2=m.create_cubic_object(m.random_coordinate_from_array(global_path),0.6,0.4,0.1)
